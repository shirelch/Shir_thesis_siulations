...
for (file in adaptive_threshold_agents_files) {
  ...
  simulate_quest(
    ...
    config    = config,
    out_file = sprintf("./adaptive_optimization_simulations/data/decreasing_threshold_simulation_results/quest_beta_0.1_decreasing_threshold_%.2f_d_d_results.RData",
                       decrease_rate),
    guessed_true_slope = 0.1
  )
}
